...
const dbCon = mysql.createConnection({
    ...
    user: "C4131NF23U78",               // replace with the database user provided to you
    password: "6134",                  // replace with the database password provided to you
    database: "C4131NF23U78",           // replace with the database user provided to you
    port: 3306
});
...
dbCon.connect(function (err) {
    ...
    const rowToBeInserted = {
        ...
        acc_email:'thisisafakeemail@gmail.com'
    };
